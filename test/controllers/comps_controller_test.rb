...
class CompsControllerTest < ActionController::TestCase
  ...
  test "should create comp" do
    assert_difference('Comp.count') do
      post :create, comp: { address: @comp.address, date: @comp.date, name: @comp.name, price: @comp.price }
    end
  ...
  test "should update comp" do
    patch :update, id: @comp, comp: { address: @comp.address, date: @comp.date, name: @comp.name, price: @comp.price }
    assert_redirected_to comp_path(assigns(:comp))
  end
